...
#define APP_ID          @"wx2b9f3743e96b5e07"               //APPID
#define APP_SECRET      @"cce65cd472d6748641198aa040319c25" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1337870901"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"aaa112123dasfsifjidaidjaidjasidd"
//支付结果回调页面
#define NOTIFY_URL      @"http://101.201.81.42/api/wxnotify_url"
//获取服务器端支付数据地址（商户自定义）
